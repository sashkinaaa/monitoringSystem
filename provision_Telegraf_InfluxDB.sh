...
# Install InfluxDB from local RPM file
sudo yum localinstall -y /vagrant/shared/InfluxDB2-2.7.6-1.x86_64.rpm
...
sudo systemctl status influxd || { sudo journalctl -xe; exit 1; }
